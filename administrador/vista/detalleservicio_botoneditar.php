		...
		$servicio=$fila_usu['descripcion'];
          $costo=$fila_usu['costo'];
                        ...
                        <tr>
                            ...
                            <td><a href='../controles/detalleservicio_editar.php?nronotaservicio=<?php echo $id_nota ;?>'> Editar</a>
            ...
            <div>
                ...
                <a href="detalleservicio_botoneditar.php" class="btn btn-danger" class="button">EDITAR</a>
                <a href="detalleservicio_boton_eliminar.php" class="btn btn-danger" class="button">ELIMINAR</a>
